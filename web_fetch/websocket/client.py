...
class WebSocketClient:
    ...
    async def send_text(self, text: str) -> None:
        ...
        message = WebSocketMessage(type=WebSocketMessageType.TEXT, data=text)
            ...
            async for msg in self._websocket:
                if msg.type == WSMsgType.TEXT:
                    message = WebSocketMessage(
                        type=WebSocketMessageType.TEXT, data=msg.data
                    )
                    ...
                    message = WebSocketMessage(
                        type=WebSocketMessageType.BINARY, data=msg.data
                    )
                    self._messages_received += 1
                    self._bytes_received += message.size
                    ...
                    message = WebSocketMessage(
                        type=WebSocketMessageType.PONG, data=msg.data
                    )
