...
class FirecrawlCrawler(BaseCrawler):
    ...
    async def scrape(self, request: CrawlerRequest) -> CrawlerResult:
        ...
        try:
            ...
            # Execute scrape
            result = await self.async_client.scrape_url(url=str(request.url), **options)
    ...
    async def crawl(self, request: CrawlerRequest) -> CrawlerResult:
        ...
        try:
            ...
            # Execute crawl
            result = await self.async_client.crawl_url(url=str(request.url), **options)
    ...
    async def search(self, request: CrawlerRequest) -> CrawlerResult:
        ...
        try:
            ...
            options = {"limit": request.max_results or 5, "formats": ["markdown"]}
