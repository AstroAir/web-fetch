...
class FileUploadHandler:
    ...
    async def upload_file(
        ...
        content_type = file_config.content_type or mimetypes.guess_type(str(file_path))[0] or 'application/octet-stream'
    ...
    async def upload_file_multipart(
        ...
        async with aiofiles.open(file_path, 'rb') as f:
            for chunk_index in range(num_chunks):
                ...
                # Update progress
                progress.bytes_uploaded = min((chunk_index + 1) * self.chunk_size, file_size)
