        ...
        for part in parts[1:]:
            if '=' in part:
                ...
                if attr_name == 'domain':
                    ...
                    try:
                        cookie.expires = datetime.strptime(attr_value, '%a, %d %b %Y %H:%M:%S %Z')
                    except ValueError:
                        pass
        ...
        try:
            ...
            for domain, cookies in data.items():
                ...
                for name, cookie_data in cookies.items():
                    ...
                    cookie_data['created_at'] = datetime.fromisoformat(cookie_data['created_at'])
                    cookie_data['last_accessed'] = datetime.fromisoformat(cookie_data['last_accessed'])
...
class CookieManager:
    ...
    def process_response_cookies(self, response_headers: Dict[str, str], url: str) -> None:
        """
