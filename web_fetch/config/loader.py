...
class ConfigLoader:
    ...
    def _load_from_file(self, config_file: Optional[Union[str, Path]] = None) -> Optional[Dict[str, Any]]:
    ...
    def _load_from_environment(self) -> Dict[str, Any]:
        ...
        env_mappings = {
            ...
            f"{self.env_prefix}CONNECTION_TIMEOUT": ("performance", "connection_timeout"),
