...
class SensitiveDataFilter(logging.Filter):
    ...
    def __init__(self):
        ...
        self.patterns: List[Pattern] = [
            ...
            re.compile(r'(authorization["\s]*[:=]["\s]*["\']?)([a-zA-Z0-9+/=]{20,})', re.IGNORECASE),
    ...
    def filter(self, record: logging.LogRecord) -> bool:
        ...
        with self._lock:
            ...
            if current_time - last_time >= self.min_interval:
                ...
                if dropped > 0:
                    record.msg = f"{record.getMessage()} (dropped {dropped} similar messages)"
                    record.args = ()
...
class ComponentFilter(logging.Filter):
    ...
    def __init__(self, component: str, allowed_levels: Set[str] = None):
        """
        ...
        self.allowed_levels = allowed_levels or {'DEBUG', 'INFO', 'WARNING', 'ERROR', 'CRITICAL'}
