...
class DatabaseComponent(ResourceComponent):
    ...
    async def _get_postgresql_pool(self) -> Any:
    ...
    async def _get_mongo_client(self) -> Any:
    ...
    async def __aenter__(self) -> "DatabaseComponent":
    ...
    async def __aexit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> None:
        ...
        if self._mongo_client:
            self._mongo_client.close()  # type: ignore[unreachable]
